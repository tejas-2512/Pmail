        ...
        <input
          ...
          onChange={(e) => {
            if (action == "newcompose") {
              // targetEmail = targetEmail.substr(0, targetEmail.indexOf('@')).concat("@gmail.com")
              settoAdress(e.target.value);
              // settoAdress(targetEmail);
            }
          }}
...
async function SendMail(
  ...
  let sentTo = toAddress.substr(0, toAddress.indexOf('@')).concat("@gmail.com")
  let mailOptions = {
    from: userHome,
    // to: toAddress,
    to: sentTo,
